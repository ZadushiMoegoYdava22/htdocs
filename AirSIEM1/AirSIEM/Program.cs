...
namespace AirSIEM
{
    class Program
    {
        ...
        // RabbitMQ settings
        private static string rabbitUri = GetAppSetting("RabbitMQUri", "amqp://127.0.0.1");
        ...
        private static string MongoDBConnectionString = GetAppSetting("MongoDBConnectionString", "mongodb://127.0.0.1:27017");
